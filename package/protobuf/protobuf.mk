...
#VERSION CHANGED DUE TO INCOMPATIBILITY WITH OLA
...
HOST_PROTOBUF_CONF_OPTS += -Dprotobuf_BUILD_TESTS=OFF
HOST_PROTOBUF_CONF_OPTS += -Dprotobuf_BUILD_EXAMPLES=OFF
HOST_PROTOBUF_CONF_OPTS += -Dprotobuf_BUILD_CONFORMANCE=OFF
